...
class Gui:
    def __init__(self, master=None):
        ...
        self.label_hole_length.grid(column='0', pady='5', row='3')
        ...
        self.combobox_connecting_shape.grid(column='1', columnspan='3', pady='5', row='5')
        self.label_connecting_dim = ttk.Label(self.frame1)
        self.label_connecting_dim.configure(text='Connecting Tube Diameter')
        self.label_connecting_dim.grid(column='0', pady='5', row='6')
        ...
        self.entry_chamber_pressure.grid(column='2', pady='5', row='10')
        self.separator2 = ttk.Separator(self.frame1)
        self.separator2.configure(orient='horizontal')
        self.separator2.grid(column='0', columnspan='4', ipadx='100', padx='5', row='11')
    ...
    def run_simulate(self):
        if self.toplevel2.state() == 'normal':
            ...
            try:
                ...
                self.append_txt("One or more entries is not a valid number")
                run = False
            if run:
                if self.combobox_hole_shape.get() == 'Circle':
                    optimized_dim = self.optimize_circle('circle', dim_o, len_o, shp_c, dim_c, len_c, thr, ch_p,
    ...
    def optimize_circle(self, shape_o, diameter_o, length_o, shape_c, diameter_c, length_c, throughput,
                        chamber_pressure, gamma, molar_mass, particle_diameter, viscosity, temp, r_0):
        current_dim = diameter_o
        depth = 0
        ...
        self.append_txt('\n')
        q = GasNetworkSim.sim_circle(shape_o, current_dim, length_o, shape_c, diameter_c, length_c, throughput,
                                     chamber_pressure, gamma, molar_mass, particle_diameter, viscosity, temp, r_0)
        ...
        while depth < max_depth:
            ...
            self.append_txt('\n')
            temp_q = GasNetworkSim.sim_circle(shape_o, temp_dim, length_o, shape_c, diameter_c, length_c, throughput,
